...
/// Custom exception class for handling errors in the LicenseChecker application.
///
...
class LicenseCheckerFlutterException implements Exception {
  /// Creates an instance of [LicenseCheckerFlutterException].
  ///
...
/// Enumeration representing various types of exceptions that can occur in the LicenseChecker application.
